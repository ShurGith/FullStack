  ...
  return (
    <>
      ...
      >
        ...
        <button
          type="submit"
          className="flex justify-center  items-center  gap-x-10 mt-5 w-full bg-indigo-600 p-2 textWhite font-bold text-lg cursor-pointer rounded  text-(--white-apagado) hover:bg-indigo-500 transition-colors duration-300"><svg xmlns="http://www.w3.org/2000/svg" className="size-12" viewBox="0 0 48 48">
